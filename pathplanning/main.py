...
#        oy.append(60 - i)
   ...
   wayPoint1 = m.map[wayPoint1[0]][wayPoint1[1]]
   wayPoint2 = m.map[wayPoint2[0]][wayPoint2[1]]
   wayPoint3 = m.map[wayPoint3[0]][wayPoint3[1]]

   dstar = Dstar(m)
   rx, ry = dstar.run(start, wayPoint1)
   print("1 " , rx)
   rx1,ry1 = dstar.run(wayPoint2,wayPoint3)
   print("2 " , rx1)
   rx2,ry2 = dstar.run(wayPoint2,wayPoint3)
   print("3 " , rx2)
   rx3,ry3 = dstar.run(wayPoint3,end)
   print("4 " , rx3)
